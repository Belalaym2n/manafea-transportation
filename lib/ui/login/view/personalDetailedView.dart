...
import 'package:manafea/ui/login/connector/personalDetailedConnector.dart';
import 'package:manafea/ui/login/viewModel/personalDetailedVeiwModel.dart';
...
class _PersonalDetailedScreenState
  ...
  void initState() {
    ...
    viewModel.loadPhoneNumber();  // تأكد من استدعاء الدالة باستخدام الأقواس
  }
                    ...
                    body: Stack(
                      children: [
                         UserPersonalDetailsItem(
                           ...
                           phoneNumber:view.phoneNumber??'not exist phone number',
